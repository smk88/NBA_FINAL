...
class gsp_NBA_VIT_roleshow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (roleInstance?.role)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("role.role.label"),'default':("Role")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(roleInstance),'field':("role")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
createTagBody(2, {->

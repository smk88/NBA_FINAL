...
class gsp_NBA_VIT_GAindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/GA/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'GA.label', default: 'GA'))],-1)
printHtmlPart(2)
createTagBody(2, {->
createTagBody(3, {->

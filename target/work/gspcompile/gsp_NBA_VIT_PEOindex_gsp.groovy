...
class gsp_NBA_VIT_PEOindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/PEO/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'PEO.label', default: 'PEO'))],-1)
printHtmlPart(2)
createTagBody(2, {->
createTagBody(3, {->

...
class gsp_NBA_VIT_programindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('message','g',29,['code':("program.department.label"),'default':("Department")],-1)
printHtmlPart(14)
loop:{
int i = 0
...
invokeTag('link','g',37,['action':("show"),'id':(programInstance.id)],3)
printHtmlPart(17)
expressionOut.print(fieldValue(bean: programInstance, field: "department"))
printHtmlPart(18)
i++
}
}
printHtmlPart(19)
invokeTag('paginate','g',46,['total':(programInstanceCount ?: 0)],-1)
printHtmlPart(20)
})

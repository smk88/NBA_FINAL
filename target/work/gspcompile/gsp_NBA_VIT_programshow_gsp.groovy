...
class gsp_NBA_VIT_programshow_gsp extends GroovyPage {
...
printHtmlPart(17)
if(true && (programInstance?.department)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("program.department.label"),'default':("Department")],-1)
printHtmlPart(19)
createTagBody(3, {->
expressionOut.print(programInstance?.department?.encodeAsHTML())
})
invokeTag('link','g',39,['controller':("department"),'action':("show"),'id':(programInstance?.department?.id)],3)
printHtmlPart(16)
}
printHtmlPart(20)
createTagBody(2, {->
...
invokeTag('link','g',47,['class':("edit"),'action':("edit"),'resource':(programInstance)],3)
printHtmlPart(22)
...
invokeTag('form','g',50,['url':([resource:programInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(24)
})

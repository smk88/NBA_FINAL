...
class gsp_NBA_VIT_logincreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(loginInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(loginInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:loginInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1443880616000L

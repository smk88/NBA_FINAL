...
class gsp_NBA_VIT_loginshow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (loginInstance?.username)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("login.username.label"),'default':("Username")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(loginInstance),'field':("username")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (loginInstance?.pwd)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("login.pwd.label"),'default':("Pwd")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(loginInstance),'field':("pwd")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
...
invokeTag('link','g',56,['class':("edit"),'action':("edit"),'resource':(loginInstance)],3)
printHtmlPart(24)

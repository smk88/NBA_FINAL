...
class gsp_NBA_VIT_employeeHomecourseInstructor_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/employeeHome/courseInstructor.gsp" }
public Object run() {
Writer out = getOut()

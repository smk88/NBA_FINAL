...
<div class="w3-card-2" style="width:90%;margin-left: 5%;margin-top: 3%">
    <div class="label w3-blue-grey col-lg-12" style="font-size: 1.2em">Create GA</div>
    <g:formRemote url="[controller:'PO', action:'saveGA']" method="post" name="remoteCreateCOForm" update="newContent" onComplete="displayMsg()" >
        ...
        <g:checkBox name="is_lock" value="${POInstance?.is_lock}" />
            ...
            <tr > <td class="col-lg-1">
                    <div class="fieldcontain ${hasErrors(bean: POInstance, field: 'po_statement', 'error')} ">
                        ...
                        <g:textArea class="w3-input" name="po_statement" value="${POInstance?.po_statement}"/>
                    </div></td></tr>
                    <!--

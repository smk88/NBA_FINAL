...
<g:formRemote url="[controller:'PO', action:'updateGA']" method="post" name="remoteCreateCOForm" update="newContent" onComplete="displayMsg()" >
...
<tr> <td class="col-lg-1">
   ...
   <g:submitButton name="update" class="btn w3-btn w3-blue-grey btn-md active" value="${message(code: 'default.button.update.label', default: 'Update')}" />
 </td></tr>
        </table>
</g:formRemote>

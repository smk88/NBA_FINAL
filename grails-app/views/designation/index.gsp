		...
		<div id="list-designation" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="designation" title="${message(code: 'designation.designation.label', default: 'Designation')}" />
				...
				<g:each in="${designationInstanceList}" status="i" var="designationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${designationInstance.id}">${fieldValue(bean: designationInstance, field: "designation")}</g:link></td>

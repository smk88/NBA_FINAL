	...
	<body>
		...
		<div id="show-designation" class="content scaffold-show" role="main">
			...
			<ol class="property-list designation">
				...
				<g:if test="${designationInstance?.designation}">
				<li class="fieldcontain">
					<span id="designation-label" class="property-label"><g:message code="designation.designation.label" default="Designation" /></span>
					
						<span class="property-value" aria-labelledby="designation-label"><g:fieldValue bean="${designationInstance}" field="designation"/></span>

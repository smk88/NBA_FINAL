...
<html>
    ...
    <body>
        ...
        <div id = "container">
            <div class = "sidebar">
                <ul id = "sideBarList"> 
                    <li> <li><g:link controller="EmployeeHome" action="createCo" <a href = "#"> <img src = "${resource(dir: 'images', file: 'add_PO-PEO-GA.png')}">&nbsp;Create/Edit CO</a></g:link></li>
            ...
            <div class = "content1">
                <div class="w3-card-2" style="width:60%;height: 60%;margin-left: 20%;margin-top: 3%">
                    ...
                    <div class="label w3-blue-grey col-lg-12" style="font-size: 1.2em">Set CO-PO Mapping</div>  <br><br> 
                    <g:form controller="COPOMapping" action="COPOMap_Create">
